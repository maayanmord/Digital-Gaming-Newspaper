    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ArticleLikesId = table.Column<int>(type: "int", nullable: false),
                    UserLikesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleUser", x => new { x.ArticleLikesId, x.UserLikesId });
                    table.ForeignKey(
                        name: "FK_ArticleUser_Article_ArticleLikesId",
                        column: x => x.ArticleLikesId,
                        principalTable: "Article",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticleUser_User_UserLikesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comment_Article_RelatedArticleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleUser_UserLikesId",
                table: "ArticleUser",
                column: "UserLikesId");

            migrationBuilder.CreateIndex(
                name: "IX_Comment_RelatedArticleId",
                table: "Comment",
